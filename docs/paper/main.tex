...
\title{HE-OFT: Privacy-Preserving One-Shot Federated Fine-Tuning under Homomorphic Encryption}
...
permitted where the model is itself a regulated or proprietary asset. 

We present
HE-OFT, the first one-shot federated fine-tuning protocol, where the resulting final model is
...
projects 124E091 and 124N941. The authors used Claude Sonnet 5 and Claude Opus 5 to enhance the
