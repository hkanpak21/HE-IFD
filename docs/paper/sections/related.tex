...
These share our structural niche, but they run an optimiser on ciphertexts, hence multiplicative depth grows with
the step count.}
...
unit, but they run an optimiser on ciphertexts, thus multiplicative depth grows with
...
statistical bound on how much a released artifact can reveal, and it pays for
that bound in accuracy. Encryption makes a contribution computationally indistinguishable
