...
loop~\cite{zhang2020batchcrypt,li2025shelora}.
...
features under
CKKS~\cite{lee2023hetal,frery2025private}.
...
the step count. Several of them are
also single-party.
...
fuse the models directly~\cite{zhang2022dense,dai2024coboosting,tang2024fusefl}.
...
task-vector merging~\cite{ilharco2023editing}. None
...
cost~\cite{zhang2025nexus,pang2024bolt}. The map served here is linear in the features, so serving a
