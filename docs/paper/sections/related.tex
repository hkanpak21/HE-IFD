...
infer membership from a released model, and
against models that generalise well they identify few members, and only at
...
polynomial approximations~\cite{sav2021poseidon}. The guarantee is strong and the model
...
collaboration of mutually distrustful parties.
...
data. A recent method sends no model at all, having each client run a frozen
...
task-vector merging, and one
round of fine-tuning suffices for foundation models in
plaintext~\cite{ilharco2023editing}. None
