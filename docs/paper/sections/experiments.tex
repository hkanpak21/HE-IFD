...
\cref{sec:threat} admits. On the language task the leakage is at the level of random guessing: the LiRA
attack reaches an AUC of $0.49$--$0.50$ and a true-positive rate of about $1\%$ at a $1\%$ false-positive
rate, indistinguishable from chance, for both adversaries. A participant therefore learns essentially nothing
about another's membership from the shared model beyond what any usable classifier of that data would reveal.
