...
\begin{table}[t]
\centering
\caption{HE-IFD accuracy across label heterogeneity (DBpedia, $\Nc=10$, three seeds); centralized
$\approx 0.99$ throughout.}
\label{tab:het}
\footnotesize
\begin{tabular}{lccccc}
\toprule
$\alpha$ & 0.05 & 0.10 & 0.30 & 1.00 \\
\midrule
HE-IFD & 0.87 & 0.93 & 0.96 & 0.98 \\
gap    & 0.12 & 0.06 & 0.03 & 0.01 \\
\bottomrule
\end{tabular}
\normalsize
\end{table}
