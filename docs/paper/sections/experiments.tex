...
memorise the most per class, and exactly the task where the accuracy gap to centralized is largest. On the
$100$-class CIFAR-100, whose vision MIA we report once the freeze-$A$ re-run completes
\textcolor{red}{[TODO]}, the same coverage effect predicts a similarly mild elevation at a large label space.
...
CIFAR-100 (100) & \textcolor{red}{??} & \textcolor{red}{??} \\
\bottomrule
\end{tabular}
\normalsize
\end{table}
