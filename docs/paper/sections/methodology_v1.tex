...
and its own adapter in plaintext, and the shared trained quantity cannot be placed
...
or to decrypt an intermediate value, which returns the values the serving
