...
confidential records across institutions~\cite{gdpr2016,hipaa}. Competitive concerns
...
$54.5\%$~\cite{nasr2019comprehensive}. A server, free to choose the weights it
broadcasts, can harvest client inputs
outright~\cite{boenisch2023curious}. Two things therefore set the attack surface, namely what a protocol reveals while
...
plaintext~\cite{zhang2022dense,tang2024fusefl}, or protects it
...
health, biometrics, and credit~\cite{euaiact2024}. Such deployments need a
...
encrypted head and takes the argmax under encryption.
