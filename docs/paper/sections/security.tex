...
\paperonly{One mechanism would check provenance rather than content.
...
restoration is deterministic as well. A client can therefore recompute the
prescribed output ciphertext and compare it as a string.}
