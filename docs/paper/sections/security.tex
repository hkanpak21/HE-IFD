...
key-switching transcript for it.
For each query of a corrupted client, the simulator holds the answer in
$\mathsf{out}_{\mathcal{A}}$ and simulates the key switch in the
same way. Queries by honest clients are simulated as key switches of encryptions of zero.
