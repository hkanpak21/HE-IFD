...
\cref{sec:experiments} that the shared frame is necessary --- without it the one-shot combination collapses
--- and that the frozen backbone supplies it without any alignment phase.
