...
step before training, the property that most distinguishes HE-OFT from prior one-shot federated learning,
...
The selection itself could not usefully move under encryption: it is data-dependent --- candidates are
scored on held-out client data the server does not have --- and homomorphic comparison would require deep
polynomial approximations of the sign function, exactly the circuit cost the design avoids, for a step the
clients perform at no cost after decryption.
