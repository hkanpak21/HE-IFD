...
1. `SUBMISSION.txt` in this folder. This is the manuscript under review, eleven pages, as a TNSE referee would receive it. It is a revision, so judge it as it stands rather than against any earlier version. Read all of it.
