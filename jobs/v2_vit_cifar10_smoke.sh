...
#
# v2 ViT-B/16 + LoRA + CIFAR-10 SMOKE TEST
#   N=4, seed=42, methods=M0,M1, alpha=0.1, teacher_epochs=3, K=3, rank=8
# Goal: confirm pipeline runs end-to-end and gives sensible numbers
# (cells should beat best_teacher because backbone+LoRA on CIFAR-10 is easy).
